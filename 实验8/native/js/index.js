...
window.onload = function () {
    ...
    btn_picture.onclick = function () {
        change_page(page_picture, page_blank, page_data, btn_picture, btn_blank, btn_data);
    ...
    btn_data.onclick = function () {
        ...
        large.style.display = 'none';
        change_page(page_data, page_blank, page_picture, btn_data, btn_blank, btn_picture);
    ...
    btn_blank.onclick = function () {
        ...
        large.style.display = 'none';
        change_page(page_blank, page_picture, page_data, btn_blank, btn_picture, btn_data);
